// This is a modification of Wordle, a game hosted by The New York Times, who presumably own the
// copyright to its unaltered code.
;(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
    ...
    var _a = "mailto:wordle-time-travel@bikko.org"
    function Ea(e) {
    ...
    La.innerHTML =
      '\n  <style>\n.mod-notice {\n    font-size: 18px;\n    font-weight: bold; margin-top: 36px; }\n    .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">High Contrast Mode</div>\n          <div class="description">For improved color vision</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback about this mod</div>\n        </div>\n        <div class="control">\n          <a href="'
        .concat(
          ...
          '" title="wordle-time-travel@bikko.org">Email</a>\n        </div>\n      </div>\n      <div class="mod-notice">This is a modified version of New York Times\'s Wordle.</div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div id="copyright">&#169; '
        )
        .concat(
    ...
    function as() {
      return (
        ...
        (Ka = setInterval(function () {
          es.getItem(Qa) && (es.removeItem(Qa), window.location.reload(!0))
        }, 432e5))
      )
    }
      ...
      if (ts) {
        try {
          ...
          window.history.replaceState(
            {},
            document.title,
            new URL(location.pathname, location.href).href + hash
          )
        }
      }
    }
  ...
  <game-theme-manager>
    <header>
      ...
      <div class="menu-right">
        <div id="current"></div>
        <button id="yesterday" class="icon">⇦</button>
        <button id="tomorrow" class="icon">⇨</button>
    ...
    var ls = "IN_PROGRESS",
      ...
      ms = (function (e) {
        ...
        function t() {
          ...
          const hackOffset = getDayOffset()
          if (hackOffset !== n.hackOffset) {
            e.tileIndex = 0
            e.rowIndex = 0
            e.solution = undefined
            e.boardState = undefined
            e.evaluations = undefined
            e.canInput = true
            n.gameStatus = "IN_PROGRESS"
            n.lastCompletedTs = undefined
            e.letterEvaluation = {}
            n.lastPlayedTs = undefined
            e.dayOffset = e.dayOffset + hackOffset
            e.hackOffset = hackOffset
            e.today = new Date(+e.today + hackOffset * 864e5)
          }
          return (
            ...
            },
            {
              ...
              value: function () {
                ...
                this.shadowRoot.getElementById(
                  "current"
                ).innerText = `${dayOfWeek}, ${currentDate} - #${this.dayOffset}`
                ...
                this.shadowRoot
                  ...
                  .addEventListener("click", function (_e) {
                    ...
                    const offset = getDayOffset() - 1
                    const url = `${href}#offset=${offset}`
